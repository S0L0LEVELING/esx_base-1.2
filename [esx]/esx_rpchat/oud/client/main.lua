...
Citizen.CreateThread(function()
	...
	TriggerEvent('chat:addSuggestion', '/anontwt',   _U('try_help'),  { { name = _U('generic_argument_name'), help = _U('generic_argument_help') } } )	
	TriggerEvent('chat:addSuggestion', '/mod',   _U('try_help'),  { { name = _U('generic_argument_name'), help = _U('generic_argument_help') } } )	
	TriggerEvent('chat:addSuggestion', '/man',   _U('try_help'),  { { name = _U('generic_argument_name'), help = _U('generic_argument_help') } } )	
	TriggerEvent('chat:addSuggestion', '/hman',   _U('try_help'),  { { name = _U('generic_argument_name'), help = _U('generic_argument_help') } } )	
	TriggerEvent('chat:addSuggestion', '/beh',   _U('try_help'),  { { name = _U('generic_argument_name'), help = _U('generic_argument_help') } } )	
end)
...
AddEventHandler('onResourceStop', function(resource)
	if resource == GetCurrentResourceName() then
		...
		TriggerEvent('chat:removeSuggestion', '/mod')
		TriggerEvent('chat:removeSuggestion', '/man')
		TriggerEvent('chat:removeSuggestion', '/hman')
		TriggerEvent('chat:removeSuggestion', '/beh')
	end
end)
