...
Config.Zones = {
  ...
  Cloakroom = {
	...
	hint = 'Druk op ~INPUT_CONTEXT~ om toegang te krijgen tot de kleedkamer.',
  },
  ...
  VehicleSpawner = {
	...
	hint = 'Druk op ~INPUT_CONTEXT~ om toegang te krijgen tot de garage.',
  },
  ...
  VehicleDeleter = {
	...
	BlipSprite = 384,
	BlipColor = 1,
	BlipName = Config.nameJobLabel.." : Breng voertuig terug",
	hint = 'Druk op ~INPUT_CONTEXT~ om het werkvoertuig op te slaan',
  },
  ...
  Vente = {
	...
	ItemDrop = 100,
	ItemPrice  = 450,
	hint = 'Druk op ~INPUT_CONTEXT~ om W.C-bonnen te verzilveren',
  },
