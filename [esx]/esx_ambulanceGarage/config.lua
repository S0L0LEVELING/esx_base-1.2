...
Config.ambulanceVehicles = {
    { model = '', label = '===========Ambulance============='},
        { model = 'ambum', label = 'Ambulance Blokkendoos'},
        { model = 'ambuamarok', label = 'Ambulance Amarok'},
        { model = 'eclass', label = 'E-Class Ambulance'},
        { model = 'ambulance2', label = 'Mercedes Ambulance'},
        { model = 'dambulance', label = 'Dieren Ambulance'},
        { model = 'ambulance4', label = 'Otaris OOV'},
        { model = 'AmbuZirkon', label = 'M-B Ambulance Zirkon'},
		{ model = 'ambulance5', label = 'ambu5'},
        { model = '', label = '=============Specialist=============='},
        { model = 'amodelx', label = 'Model X Huisarts Ambulance'},
        { model = 'amb1', label = 'Volvo XC40 Ambulance RR'},
        { model = 'AmbuMOut', label = 'Mitsubishi Outlander RR'},
        { model = 'AmbuBMW', label = 'Ambulance BMW 525D RR'},
        { model = 'ambulance', label = 'VW Touran Ambulance RR'},
        { model = 'ambumotor', label = 'Ambulance Motor RR'},
        { model = 'amb2', label = 'Mercedes GLC Huisarts Ambulance'},
        { model = 'AmbuOVDG', label = 'Skoda Ambulance OVDG'},
        ...
        { model = 'brandweer', label = 'Brandweer 25-04'},
        { model = 'brandweer2', label = 'Brandweer 10-65'},
        { model = 'brandweer1', label = 'Brandweer 25-04'},
        { model = 'br2', label = 'Volvo FE Euro 6'},
        { model = 'panther', label = 'Brandweer Bluswagen'},
        { model = 'br1', label = 'Volvo FN 420'},
