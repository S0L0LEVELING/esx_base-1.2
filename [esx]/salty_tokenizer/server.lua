	...
	elseif _source == "" then -- If the request came from the server, then no need to authenticate the token
		...
		if token ~= resourceTokens[resource] then
			...
			if Config.CustomAction then
				...
				local tokenizerkick_wh = "https://discord.com/api/webhooks/940923871501090846/B27sH5cJE2o-92JV3nC31eE1LrkQ6R1X81y2hePmcKsCGDDlX8mlNN6xc73Io0xQ5sOW" 
				TriggerEvent("middelveen:log", tokenizerkick_wh, "Hacker gekicked!", "Kick message: "..Config.KickMessage.."\nNaam speler: "..GetPlayerName(source), 62207)
