...
Config.HandcuffTimer              = 10 * 100000 -- 10 mins
...
Config.PoliceStations = {
	...
	LSPD = {
		...
		Items = {
			...
			{ name = 'flashlight',    		label = 'Zaklamp',  			price = 1 },
		...
		Cloakrooms = {
			vector3(1849.8, 3695.31, 34.26),
			vector3(452.08, -992.67, 30.69),
			vector3(-1100.43, -847.41, 19.59),
			vector3(-452.46, 6016.54, 31.72)
		},	

		Armories = {
			vector3(1846.01, 3692.77, 34.26),
			vector3(452.04, -980.12, 30.69),
			vector3(467.72, -993.15, 23.92),
			vector3(-1095.77, -841.05, 19.59),
