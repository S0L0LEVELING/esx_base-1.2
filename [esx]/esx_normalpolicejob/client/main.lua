...
function OpenPoliceActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'police_actions', {
		...
		elseif  data.current.value == 'medisch_interaction' then
			local elements = {
				{label = "  ❤️  START REANIMEREN ❤️ ",       value = 'revive'},
				{label = " <font color='grey'>------------------------------------------------------------------------------------------</font>     "},
				{label = " ⚠️ Aanvraag <font color='yellow'>AMBULANCE</font> <small>(<font color='darkred'>A1, Directe inzet: ja</font>)</small> ⚠️   ",       value = 'aanvraag_ambu2'},
				{label = " ⚠️  Aanvraag <font color='yellow'>AMBULANCE</font> <small>(<font color='darkred'>A2, Directe inzet: ja</font>)</small>  ⚠️  ",       value = 'aanvraag_ambu'}
			}
...
function OpenGetStocksMenu()
	ESX.TriggerServerCallback('esx_politie:getStockItems', function(items)
		local elements = {}
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_get_item_count', {
				...
				if not count then
					...
					menu2.close()
					menu.close()
					TriggerServerEvent('esx_politie:getStockItem', itemName, count)
...
function OpenPutStocksMenu()
	ESX.TriggerServerCallback('esx_politie:getPlayerInventory', function(inventory)
		local elements = {}
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_put_item_count', {
				...
				if not count then
					...
					menu2.close()
					menu.close()
					TriggerServerEvent('esx_politie:putStockItems', itemName, count)
