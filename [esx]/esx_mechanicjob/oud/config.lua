...
Config.Zones = {
	...
	MechanicActions = {
		Pos   = { x = -197.86, y = -1332.99, z = 30.009 },
	...
	Craft = {
		Pos   = { x = -196.84, y = -1319.14, z = 30.09 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 1
	},
	...
	VehicleSpawnPoint = {
		Pos   = { x = -185.12, y = -1287.07, z = 31.3 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1
	},

	VehicleDeleter = {
		Pos   = { x = -150.09, y = -1296.91, z = 30.02 },
	...
	VehicleDelivery = {
		Pos   = { x = -162.92, y = -1307.66, z = 31.26 },
