Locales['nl'] = {
    ...
    ['being_searched'] = 'Je wordt ~y~gefouilleerd~s~ door de ~b~kmar~s~',
    -- Voertuig Interactie
    ...
    ['kmar_stock'] = 'Kmar Voorraad',
    ['revive'] = 'Revive speler',
    -- Misc
    ...
    -- Noodsignaal
    ['distress_sent'] = 'Noodsignaal is verstuurd naar alle eenheden!',
    ['kmar_distress_message'] = 'KMAR attentie!: AGENT HEEFT HULP NODIG!',
    ['police_distress_message'] = 'Politie attentie!: KMAR HEEFT HULP NODIG!',
    ['ambu_distress_message'] = 'Ambulance attentie!: KMAR HEEFT HULP NODIG!',
    -- Item
