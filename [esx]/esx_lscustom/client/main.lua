...
Citizen.CreateThread(function()
	while true do
		...
		if IsPedInAnyVehicle(playerPed, false) then
			...
			if (PlayerData.job and PlayerData.job.name == 'mechanic' and PlayerData.job.grade_name == 'boss') or (PlayerData.job and PlayerData.job.name == 'mechanic' and PlayerData.job.grade_name == 'chief') or (PlayerData.job and PlayerData.job.name == 'mechanic' and PlayerData.job.grade_name == 'experimente') or not Config.IsMechanicJobOnly then
				for k,v in pairs(Config.Zones) do
