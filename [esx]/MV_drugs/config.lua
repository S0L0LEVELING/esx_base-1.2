...
Config.CircleZones = {
	...
	WeedProcessing = {coords = vector3(1035.95, -3205.66, -39.17), name = _U('blip_weedprocessing'), color = 25, sprite = 496, radius = 20.0},
	
	--meth
	MethProcessing = {coords = vector3(1009.83, -3194.95, -38.99), name = _U('blip_methprocessing'), color = 25, sprite = 496, radius = 0.0},
	...
	CokeProcessing = {coords = vector3(1092.86, -3196.67, -38.99), name = _U('blip_Cokeprocessing'),color = 25, sprite = 496, radius = 20.0},

	--Opium
	OpiumProcessing = {--[[coords = vector3(905.66, -3226.71, -99.10), name = _U('blip_Opiumprocessing'),color = 25, sprite = 496, radius = 20.0]]},
	...
	--Heroin
	HeroinField = {--[[coords = vector3(1336.17, 1277.11, 105.84), name = _U('blip_heroinfield'), color = 25, sprite = 496, radius = 20]]},
