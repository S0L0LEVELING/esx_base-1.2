...
-- You can disable the Ragdoll keybinding here.
    ...
    CoolDownTime = 2 * 1000,  -- Voorste Getal in Seconden veranderen!
-- Handen omhoog.
	HandenomhoogEnabled = true,
	HandenomhoogKeybind = 311, -- Get the button number here https://docs.fivem.net/game-references/controls/
-- Wijzen.
	WijzenEnabled = true,
	WijzenKeybind = 29, -- Get the button number here https://docs.fivem.net/game-references/controls/
-- Crouch
	CrouchEnabled = true,
	CrouchKeybind = 36, -- Get the button number here https://docs.fivem.net/game-references/controls/
...
Config.Languages = {
  ['nl'] = {
        ...
        ['favoriteinfo'] = "Selecteer hier een emote en stel het in als favoriet.",
        ['rfavorite'] = "Reset favoriet",
        ['prop2info'] = "❓ Prop Emotes kunnen worden geloceerd op het einde.",
        ['set'] = "Instellen (",
        ['setboundemote'] = ") emote als sneltoets instellen?",
        ['newsetemote'] = "~w~ is nu je sneltoets emote, druk op ~g~CapsLock~w~ om te gebruiken.",
        ['cancelemote'] = "Annuleer Emote",
        ['cancelemoteinfo'] = "~r~X~w~ Annuleert de huidige emote",
        ['walkingstyles'] = "Loopstijlen",
        ['resetdef'] = "Reset naar standaard",
        ['normalreset'] = "Normaal (Reset)",
        ['moods'] = "Expressies",
        ['infoupdate'] = "Informatie",
        ['infoupdateav'] = "Informatie (Update beschikbaar)",
        ['infoupdateavtext'] = "Een update is beschikbaar, krijg laatste versie van ~y~https://github.com/andristum/dpemotes~w~",
        ...
        ['sentrequestto'] = "Uitnodiging verzonden naar ~y~",
        ['nobodyclose'] = "~r~Niemand~w~ in de buurt.",
        ['doyouwanna'] = "~y~Y~w~ om te accepteren, ~r~L~w~ om af te wijzen (~g~",
        ['refuseemote'] = "Emote afgewezen.",
        ['makenearby'] = "Laat de speler in de buurt spelen",
        ['camera'] = "Druk op ~y~G~w~ om camera flash te gebruiken.",
        ['makeitrain'] = "Druk op ~y~G~w~ om het te laten regenen.",
        ['pee'] = "Houdt ~y~G~w~ ingedrukt op te plassen.",
        ['spraychamp'] = "Houdt ~y~G~w~ ingedrukt om champagne te spuiten",
        ['bound'] = "Koppelen ",
        ['to'] = "Naar",
        ['currentlyboundemotes'] = " Huidige gekoppelde emotes:",
        ['notvalidkey'] = "is geen geldige sneltoets.",
