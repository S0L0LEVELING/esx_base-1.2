...
Citizen.CreateThread(function()
    TriggerEvent('chat:addSuggestion', '/e', 'Play an emote', {{ name="emotename", help="dans, camera, zit of elke andere geldige emote."}})
    TriggerEvent('chat:addSuggestion', '/e', 'Play an emote', {{ name="emotename", help="dans, camera, zit of elke andere geldige emote."}})
    TriggerEvent('chat:addSuggestion', '/emote', 'Play an emote', {{ name="emotename", help="dans, camera, zit of elke andere geldige emote."}})
    if Config.SqlKeybinding then
      TriggerEvent('chat:addSuggestion', '/emotebind', 'Sneltoets een emote', {{ name="sneltoets", help="num4, num5, num6, num7. num8, num9. Numpad 4-9!"}, { name="emotenaam", help="dance, camera, zit of elke andere geldige emote."}})
      TriggerEvent('chat:addSuggestion', '/emotebinds', 'Zie alle sneltoetsen.')
    end
    TriggerEvent('chat:addSuggestion', '/emotemenu', 'Open emote meny.')
    TriggerEvent('chat:addSuggestion', '/emotes', 'Zie alle beschikbare emotes.')
    TriggerEvent('chat:addSuggestion', '/walk', 'Zet je loopstijl.', {{ name="style", help="/walks voor een lijst met geldige stijlen"}})
    TriggerEvent('chat:addSuggestion', '/walks', 'Lijst beschikbare loopstijlen.')
end)
...
function EmoteCommandStart(source, args, raw)
  if not CoolDownActive then
    ...
    TriggerEvent('esx:showNotification', '~r~Emote spammen is niet toegestaan!')
  end
end
