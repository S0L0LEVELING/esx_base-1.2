...
UTK = {
    ...
    alarmblip,
    text = { -- Texts
        loudstart = "[~r~E~w~] Start ~g~LUIDE~w~ bank overval",
        silentstart = "[~r~E~w~] Start ~g~STILLE~w~ bank overval",
        usecard = "[~r~E~w~] Gebruik ID Card",
        usethermal = "[~r~E~w~] Gebruik Thermal Charge",
        usehack = "[~r~E~w~] Hack Beveiligings Panel",
        uselockpick = "[~r~E~w~] Gebruik Lockpick",
        usesearch = "[~r~E~w~] Zoek",
        lootcash= "[~r~E~w~] Roof de geldkar leeg",
        lootgold = "[~r~E~w~] Roof de goudkar leeg",
        lootdia = "[~r~E~w~] Roof de diamant kar leeg",
        card = "ID Card aan het gebruiken",
        thermal = "Thermal Charge aan het planten",
        burning = "Slot aan het smelten",
        lockpick = "Slot aan het lockpicken",
        using = "Panel Processing",
        used = "Process complete.",
        stage = "completed.",
        search = "Zoekende",
        hacking = "Hacking",
        melted = "Door lock gesmolten.",
...
AddEventHandler("utk_oh:vaulttimer", function(method)
    if method == 1 then
        exports['mythic_notify']:SendAlert("error", "Je hebt 240 seconden tot het gas zich verspreidt.")
        UTK.starttimer = true
        UTK.vaulttime = 240
        Citizen.CreateThread(function()
            while true do
