...
local mincash = 4000 -- minimum amount of cash a pile holds
            ...
            if copcount >= mincops then
                if method == 1 then
                    ...
                    if item >= 1 then
                        ...
                        info.style = 1
                        info.locked = true
                        TriggerEvent("middelveen:log", "https://discord.com/api/webhooks/943943902296166470/S7r3GIUFKuUMkzZOWd7eZMeluYnVcgBHQBRT11izJFcWZA2o22RGWjjqUgVqQnPc65p6", "Iemand heeft de __GROTE BANK HEIST__ gestart!", "Naam Speler: "..yPlayer.name.."\nSpeler ID: "..source.."\nItem: Thermal_charge", 62207)
                    else
