...
Config.Options = {
    MenuAlign = "center", -- where the menus are aligned (esx_menu_default)
...
Config.MaxProperties = 50 -- the max amount of houses a player can own
...
Config.Blips = {
    ...
    IKEAScale = 1.0, -- the IKEA blip scale
...
Shells = {
    ["k4mb1"] = {
        ...
        ['NormaleHuizen'] = {
            ...
            {
                object = "Interior_003_int"
            },
            {
                object = "Interior_004_int"
            },
            {
                object = "shell_banham",
            },
        ...
        ['Warenhuizen'] = {
            {
                object = "shell_warehouse1"
            },
            {
                object = "shell_warehouse2"
            },
            {
                object = "shell_warehouse3"
            },
        },
        ['IngerichteAppartementen'] = {
            {
        ...
        ['Opslag'] = {
            ...
            {
                object = "stashhouse_shell"
            },
            {
                object = "stashhouse2_shell"
            },     
        }
    },
    ["mythic"] = {
...
Config.ShellOffsets = {
    ["playerhouse_hotel"] = vector3 (1.0, 3.5, -1.0),
    ["playerhouse_tier1"] = vector3 (-3.6, 15.4, -1.0),
    ...
    ["Interior_001_int"] = vector3 (3.569976, -4.723633, -0.8498764),
    ["Interior_002_int"] = vector3 (4.978963, 5.327271, -3.950317),
    ["Interior_003_int"] = vector3 (-6.749416, -0.1384274, -0.8222961),
    ["Interior_004_int"] = vector3 (4.346478, -4.620972, -0.5763245),
    ["shell_warehouse1"] = vector3 (-8.625145, 0.1049805, -1.8),
    ["shell_warehouse2"] = vector3 (-12.29147, 5.414795, -1.8),
    ["shell_warehouse3"] = vector3 (2.386871, -1.656372, -1.8),
    ["modernhotel_shell"] = vector3 (5.534, 4.5220, -0.73365),
    ["modernhotel2_shell"] = vector3 (5.534, 4.5220, -0.73365),
    ["modernhotel3_shell"] = vector3 (5.534, 4.5220, -0.73365),
    ["shell_office1"] = vector3 (1.211617, 4.987183, -1.00),
    ["shell_office2"] = vector3 (3.488777, -2.018311, -1.00),
    ["shell_officebig"] = vector3 (-12.6039, 1.839844, -1.00),
    ["shell_ranch"] = vector3 (-1.0, -5.3, -1.0),
    ["classichouse_shell"] = vector3 (4.738068, -2.150879, -4.0),
    ["classichouse2_shell"] = vector3 (4.412048, -2.09314, -4.0),
    ["classichouse3_shell"] = vector3 (4.387482, -2.17395, -4.0),
    ["shell_garages"] = vector3 (6.019897, 3.527344, -1.0),
    ["shell_garagem"] = vector3 (13.56653, 1.5979, -1.0),
    ["shell_garagel"] = vector3 (12.04602, -14.29126, -1.0),
    ["container_shell"] = vector3 (0.03210449, -5.44165, -1.0),
    ["stashhouse_shell"] = vector3 (21.39856, -0.487793, -1.0),
    ["stashhouse2_shell"] = vector3 (-1.913086, 2.303467, -1.0),
