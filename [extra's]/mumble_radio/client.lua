...
Radio.Commands = {
	{
		...
		Help = "Pak of leg je portofoon terug.", -- Command help shown in chatbox when typing the command
		Params = {},
...
Citizen.CreateThread(function()
	...
	while true do 
		...
		-- Es SAMUR 
		if job == 'offkmar' or job == 'kmar' then
			GivePlayerAccessToFrequencies(1, 2, 5, 6)
		else
			RemovePlayerAccessToFrequencies(3, 4, 5, 6)
		end
